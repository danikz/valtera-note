...
class UpdaterService {
  ...
  isMandatory = $state<boolean>(true); // User requirement: mandatory update to protect users from bugs
  ...
  async downloadAndInstall(): Promise<void> {
    ...
    try {
      ...
      // Relaunch the app immediately with the newly installed version
      await relaunch();
    } catch (err: any) {
